...
exports.get =async (req, res) => {
    ...
    req.session.message="";
    await requestModel.find({kind:'درخواست تعمیر'}).then(async function (res2) {
    ...
    if(eshterakstatus.length>0)
        ...
        res.render('./requests/request_list', {
            ...
            activePage: {isAuthenticated: req.isAuthenticated(), sherkat_list: true, title: 'لیست درخواست های تعمیر'}
        });
    });
};
